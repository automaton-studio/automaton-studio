...
namespace Automaton.Studio.Server.Migrations
{
    ...
    [Migration("20220414172136_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthServer.Core.Domains.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AuthServer.Core.Domains.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Common.Authentication.RefreshToken<System.Guid>", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 14, 18, 21, 36, 407, DateTimeKind.Local).AddTicks(9675));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("AuthServer.Core.Domains.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("AuthServer.Core.Domains.ApplicationUser", null)
                        .WithMany()
