...
namespace Automaton.Common.Auth
{
    ...
    public class AccessTokenManagerService : IAccessTokenManagerService
    {
        ...
        /// <summary>
        /// If there is any value for this token in cache this token will revoked
        /// We store cancled token in redis cache if not exist token in our black list tokens in redis token is active
        /// </summary>
